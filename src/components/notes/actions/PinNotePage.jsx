                                ...
                                <Card style={{ width: '100%', backgroundColor: data.background,borderRadius:0 }}>
                                    <div style={{ height: 38, width: '90%', marginTop: 10, marginLeft: 10, fontWeight: 'bolder', position: 'relative' }}>
                                        ...
                                        <div id="note-btns" >
                                            <Tooltip title="Unpin note">
                                                ...
                                                >
                                                    <img src={pinnote} alt="pinnote" />
                                                </IconButton>
                                            </Tooltip>
                                        </div>
                                    </div>

                                    <div onClick={this.handleClickOpen} style={{ width: 240, marginLeft: 10, marginBottom: 10,fontSize:15 }}>{data.notedata}</div>
                                    ...
                                    <div id="note-btns" style={{ width: 240, height: 40 }}>
                                        ...
                                        <Tooltip title="Archive">
                                            <IconButton color="primary" id="notebuttons" onClick={() => { this.isArchiveNote(key, data); this.isPinNote(key, data) }}>
                                        ...
                                        >
                                            <Button id="note-menu-btn" onClick={() => { this.handleClose(); this.isPinNote(key, data); this.isTrashNote(key, data) }}>Delete note</Button>
                                            <br></br>
