...
import ArchiveNotes from '../notes/actions/ArchiveNotesPage';
                        ...
                        {   
                            ...
                            <IconButton style={{ marginLeft: 50 }} color="inherit" aria-label="Menu" onClick={this.refreshPage}>
                             ...
                             <ToggleDisplay show={this.state.viewbtn}>
                                <IconButton style={{ marginLeft: 3 }} color="inherit" aria-label="Menu" onClick={() => {this.handleViewClick();noteCtrl.notesInListView()}}>
                                    <img src={listview} alt="listview" id="topicons" />
                                </IconButton>
                            </ToggleDisplay>
                            
                            <ToggleDisplay show={!this.state.viewbtn}>
                                <IconButton style={{ marginLeft: 3 }} color="inherit" aria-label="Menu" onClick={() => {this.handleViewClick();noteCtrl.notesInGridView()}}>
